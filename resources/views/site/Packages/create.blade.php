...
<div class="col-12">
    <div class="card-body">
        <form class="form form-vertical" action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- Paket nomi -->
                <div class="col-6">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select name="avia_id" id="avia_id" class="form-control @error('avia_id') is-invalid @enderror">
                            ...
                            <option value="{{ $avia->id }}" {{ old('avia_id') == $avia->id ? 'selected' : '' }}>
                                {{ $avia->name }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select name="ticket_type_id" id="ticket_type_id"
                            ...
                            <option value="{{ $ticket->id }}" {{ old('ticket_type_id') == $ticket->id ? 'selected' : '' }}>
                                {{ $ticket->name }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ old('total_duration') }}" id="total_duration"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{ old('departure_time') }}" id="departure_time"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="date" value="{{ old('arrival_time') }}" id="arrival_time"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('visa_type') }}" id="visa_type"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('origin_city') }}" id="origin_city"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('destination_city') }}" id="destination_city"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('stopover_cities') }}" id="stopover_cities"
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('food') }}" id="food"
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('ambulance') }}" id="ambulance"
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('taxi_service') }}" id="taxi_service"
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('gift') }}" id="gift"
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea id="package_info"
                            class="form-control @error('package_info') is-invalid @enderror" name="package_info"
                            placeholder="Paket haqida batafsil ma'lumot kiriting">{{ old('package_info') }}</textarea>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('hotel_name') }}" id="hotel_name"
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ old('hotel_distance') }}" id="hotel_distance" class="form-control @error('hotel_distance') is-invalid @enderror" name="hotel_distance" placeholder="Masofani kiriting" />
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" max="5" value="{{ old('hotel_star_count') }}" id="hotel_star_count" class="form-control @error('hotel_star_count') is-invalid @enderror" name="hotel_star_count" placeholder="Yulduz sonini kiriting" />
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea id="hotel_info" class="form-control @error('hotel_info') is-invalid @enderror" name="hotel_info" placeholder="Mehmonxona haqida batafsil ma'lumot kiriting">{{ old('hotel_info') }}</textarea>
                ...
                <div class="col-12">
                    <label for="advantages">Afzallik tanlash</label>
                    <select class="form-control form-select select2 @error('advantages') is-invalid @enderror" name="advantages[]" id="advantages" multiple>
                    ...
                    <p class="text-danger">@error('advantages') {{$message}} @enderror</p>
                </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ old('count') }}" id="count" class="form-control @error('count') is-invalid @enderror" name="count" placeholder="Bilet sonini kiriting" />
